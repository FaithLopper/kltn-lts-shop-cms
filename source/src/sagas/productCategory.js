...
function* getProductCategoryById({ payload: { params, onCompleted, onError } }) {
    try {
        const apiParams = {
...
const sagas = [
    takeLatest(defineActionLoading(GET_PRODUCT_CATEGORY_LIST), getProductCategoryList),
    ...
    takeLatest(defineActionLoading(DELETE_PRODUCT_CATEGORY), deleteProductCategory),
]
